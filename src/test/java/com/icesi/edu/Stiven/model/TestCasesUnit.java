...
class TestCasesUnit {
	...
	@Autowired
	public TestCasesUnit(PersonService personServi, BusinessEntityService businessentityServi, AddressService addressServi, 
	...
	public void savePersonTwoTest() {
		...
		personServi.editPerson(1, "", "", null, namePerson, lastnamePerson, "",realModdified, "", "", null, "", ""));
	...
	public void editPerson() {
		...
		personServi.editPerson(1, "", "", null, namePerson, lastnamePerson, "",realModdified, "", "", null, "", title);

		assertEquals(p.getFirstname(), "Stiven");
		assertEquals(p.getLastname(), "Arboleda");
		assertNotEquals(p.getTitle(), "ESTE NO ES");
		assertNotNull(title);
	...
	public void saveAddress() {
		...
		a.getStateprovince().setStateprovinceid(22);
	...
	public void saveBusinessentityAddressOne() {
		...
		//BusinessentityaddressPK id, Timestamp modifieddate, Integer rowguid
	}
	/*
	...
	public void editBusinessentityAddress() {
		...
		businessentityaddressServi.editBusinessentityaddress(bsaPK, null, null);
	...
	public void editPersonphone() {
		...
		ppPK.setBusinessentityid(22);
		ppPK.setPhonenumbertypeid(03);
		ppPK.setPhonenumber("0123456789"); 
		
		pp.setId(ppPK);
		
		personphoneServi.editPersonPhone(ppPK, null);
	...
	/*
	 * CASO 2 editar una persona
	 * Numero a editar mayor a 10 digito
	 * Lanz excepcion
	 */
	@Test
	@Order(23)
	public void editPersonphoneOne() {
		...
		ppPK.setPhonenumber("987654321012"); 
	...
	/*
	 * CASO 3 editar una persona
	 * Numero a editar menor a 10 digito
	 * Lanz excepcion
	 */
	@Test
	@Order(24)
	public void editPersonphoneTwo() {
